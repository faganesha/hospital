	...
	<div class="container" style="padding-bottom: 100px">
		<div class="row justify-content-center">
			...
			<div class="col-12 pl-8 ">
				<div class="card-body">
					<form method="POST" action="{{route('mmpi.insert')}}">
						{{csrf_field()}}
							...
							<table class="table table-bordered table-hover" id="example" >
								...
								<tbody>
									...
									<tr>
										...
										<input type="hidden" name="testid[]" value="{{$mmpi->id}}">
										<td>
											<div class="form-group">
												<input  type="radio" name="answer[{{$mmpi->id}}]" id="yes" value="1">
												<label for="yes">Ya</label>
											</div>
										</td>
										<td>
											<div class="form-group">
												<input type="radio" name="answer[{{$mmpi->id}}]" id="no" value="0">
